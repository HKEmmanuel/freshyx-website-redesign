    ...
    <section className="w-full bg-[hsl(var(--background))] py-24 px-4 sm:px-6 lg:px-8 ">
      <div className="max-w-7xl mx-auto ">
        <div className="mb-16 max-w-2xl text-left">
          <h2 className="text-3xl md:text-4xl font-medium text-[hsl(var(--title))] mb-4">
        ...
        <div className="space-y-6 w-full lg:px-40">
          <div className="relative ">
            ...
            <div className="flex flex-wrap flex-row gap-15 items-center gap-15 pt-12 md:pt-18 ">
          ...
          <div className="relative">
            ...
            <div className="flex flex-wrap flex-row gap-15 flex-col gap-50  items-center gap-15 pt-12 md:pt-18">
              <div className="border-l-2 border-b-2 border-[hsl(var(--border))] h-8 w-8 absolute -left-4 top-10 hidden sm:block"></div>
