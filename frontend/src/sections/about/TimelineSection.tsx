...
const TimelineItem = ({ year, title, text, imageUrl, isLast = false }) => (
  ...
  >
    ...
    <p className="text-xl font-extra text-[hsl(var(--title))] mb-2">{year}</p>
    <h3 className="text-2xl font-extra text-[hsl(var(--title))] mb-4">
      {title}
    </h3>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start">
        <div className="w-full sticky top-24 lg:pt-0">
          <div className="text-left">
            <h1 className="text-5xl md:text-6xl font-medium text-[hsl(var(--primary))] leading-tight mb-8">
              Notre histoire <br />
              <p className="text-lg text-[hsl(var(--foreground))] mb-10 max-w-lg">
                Tout a commencé en 2023, 2 ans déjà.
              </p>
            </h1>
          </div>
          {/*<img
        ...
        <div className="w-full border-l border-[hsl(var(--primary))] pl-4 lg:pl-8">
          <TimelineItem
            ...
            text="Quelques jeunes, un rêve commun : prouver que l’Afrique peut mener la transition écologique, grâce à sa créativité et à son génie.
            "
          ...
          <TimelineItem
            ...
            text="Chaque projet, chaque campagne, chaque formation est une expérience de leadership.
Parce qu’on ne change pas le monde derrière un écran, mais les mains dans la terre et les yeux tournés vers l’avenir."
